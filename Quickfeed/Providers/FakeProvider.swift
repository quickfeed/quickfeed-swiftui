...
extension FakeProvider{
    ...
    func initTestCourses(){
        ...
        let a1 = Assignment(name: "assignment-1", id: 1, deadline: "lør. 9. jan., 23:00", courseID: 111, autoApprove: true, isGroupLab: true, skipTests: false, submission: self.sumissionsDat310Assignment1())
